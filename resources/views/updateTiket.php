		...
		<div class="card">
			...
			<div class="card-body">
                    <?php 
                        ...
                        $nama_film = $row1['nama_film'];
                        $id_film = $row1['id_film'];
                        ?>
				        <form action="updateTiketProcess.php?id_booking=<?php echo $id_booking; ?>" method="POST">
                        <div class = "container">
                        ...
                        <div class="input-group">
						    <input type="number" class="form-control" name="jml_kursi" value="<?php echo $row['jml_kursi'];?>" required>
                        </div>  
